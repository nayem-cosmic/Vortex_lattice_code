...
for i in np.arange(2,38,1):
    x_ref.append(i)
    y_ref.append(3.443*i*3.1416/180)

plt.plot(x_list, y_list, color='red', linewidth=1, linestyle='-', marker='o',label='Calculated Data')

plt.plot(x_ref, y_ref, color='green', linewidth=1, linestyle='-', label='Standard Data')



plt.title("Lift Coefficient vs. Angle of Attack\nComparison with Bertin-Russel Standard Data")
